...
$c_Lcalculator_Calculator$.prototype.trackEval$1__p1__Lcalculator_Expr__sci_Map__sci_Set__sci_Map__D = (function(e, r, explored, references$1) {
  _trackEval: while (true) {
    var x1 = e;
    if ($is_Lcalculator_Ref(x1)) {
      var x2 = $as_Lcalculator_Ref(x1);
      var name = x2.name$2;
      if (explored.contains__O__Z(e)) {
        return (NaN)
      } else {
        var temp$e = this.getReferenceExpr__p1__T__sci_Map__Lcalculator_Expr(name, references$1);
        var jsx$2 = explored;
        var array = [e];
        ...
        var temp$explored = $as_sci_Set(jsx$2.$$plus$plus__sc_GenTraversableOnce__sc_Set(jsx$1));
        e = temp$e;
        r = references$1;
        explored = temp$explored;
        continue _trackEval
      }
    } else if ($is_Lcalculator_Literal(x1)) {
      var x3 = $as_Lcalculator_Literal(x1);
      var v = x3.v$2;
      return v
      ...
      var a = x4.a$2;
      var b$1 = x4.b$2;
      return (this.trackEval$1__p1__Lcalculator_Expr__sci_Map__sci_Set__sci_Map__D(a, references$1, explored, references$1) + this.trackEval$1__p1__Lcalculator_Expr__sci_Map__sci_Set__sci_Map__D(b$1, references$1, explored, references$1))
    } else if ($is_Lcalculator_Minus(x1)) {
      var x5 = $as_Lcalculator_Minus(x1);
      var a$2 = x5.a$2;
      var b$2 = x5.b$2;
      return (this.trackEval$1__p1__Lcalculator_Expr__sci_Map__sci_Set__sci_Map__D(a$2, references$1, explored, references$1) - this.trackEval$1__p1__Lcalculator_Expr__sci_Map__sci_Set__sci_Map__D(b$2, references$1, explored, references$1))
    } else if ($is_Lcalculator_Times(x1)) {
      var x6 = $as_Lcalculator_Times(x1);
      var a$3 = x6.a$2;
      var b$3 = x6.b$2;
      return (this.trackEval$1__p1__Lcalculator_Expr__sci_Map__sci_Set__sci_Map__D(a$3, references$1, explored, references$1) * this.trackEval$1__p1__Lcalculator_Expr__sci_Map__sci_Set__sci_Map__D(b$3, references$1, explored, references$1))
    } else if ($is_Lcalculator_Divide(x1)) {
      var x7 = $as_Lcalculator_Divide(x1);
      var a$4 = x7.a$2;
      var b$4 = x7.b$2;
      return (this.trackEval$1__p1__Lcalculator_Expr__sci_Map__sci_Set__sci_Map__D(a$4, references$1, explored, references$1) / this.trackEval$1__p1__Lcalculator_Expr__sci_Map__sci_Set__sci_Map__D(b$4, references$1, explored, references$1))
    } else {
      throw new $c_s_MatchError().init___O(x1)
    }
  }
...
$c_Lcalculator_Calculator$.prototype.eval__Lcalculator_Expr__sci_Map__D = (function(expr, references) {
  return this.trackEval$1__p1__Lcalculator_Expr__sci_Map__sci_Set__sci_Map__D(expr, references, $as_sci_Set($m_s_Predef$().Set$2.apply__sc_Seq__sc_GenTraversable($m_sci_Nil$())), references)
});
...
$c_Lcalculator_Polynomial$.prototype.computeSolutions__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c, delta) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$2, b$2, c$2) {
    return (function() {
      var x1 = $uD($m_Lcalculator_Polynomial$().computeDelta__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal(a$2, b$2, c$2).apply__O());
      if ((x1 < 0)) {
        ...
        var array$1 = [(((-$uD(b$2.apply__O())) + $uD($g.Math.sqrt(x1))) / (2 * $uD(a$2.apply__O()))), (((-$uD(b$2.apply__O())) - $uD($g.Math.sqrt(x1))) / (2 * $uD(a$2.apply__O())))];
...
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.apply__T2__T2 = (function(x0$1) {
  if ((x0$1 !== null)) {
    ...
    var y = new $c_Lcalculator_Signal().init___F0(expr$2);
